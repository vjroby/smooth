...
namespace Framework
{
    ...
    class Html extends Base{
         ...
         * @param $options['wrapper'] - the element wrapper ["type" => "div", "class" =>"", "id" => ""]
         *
         * @param array $options
         * @return string
        ...
        public static function select(array $options){
            ...
            $placeholder = self::checkOptionReturnNull($options, 'placeholder');
            ...
            if (!is_null($placeholder)){
                $return .= '<option value="default" disabled>'.$default_value.'</option>';
            }
        ...
        public static function input(array $options){
            ...
            if (isset($options['inputWrapper'])){
                $tag = isset($options['inputWrapper']['tag'])? $options['inputWrapper']['tag'] : 'div';
                $return .= "<{$tag}";
                $return .= ' class="'.self::checkOption($options['inputWrapper'],'class').'" ';
                $return .= ' id="'.self::checkOption($options['inputWrapper'],'id').'" ';
                $return .= ">";
            }
         ...
         * @return string
         */
        protected static function apply_wrapper_input(array $options, $string){
